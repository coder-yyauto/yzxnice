...
async def _inspect_admin_users_page(page) -> None:
    """Inspect the admin /admin/users page (school/teacher/class panels + batch action)."""
    print("2. 导航到用户管理页面...")
    ...
    await _check_generate_students_action(page)


async def _check_generate_students_action(page) -> None:
...
async def test_user_visibility():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await _inspect_admin_users_page(page)
